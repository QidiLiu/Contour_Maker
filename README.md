...
| A: Otsu+contour-refiner（YOLO 框，真实流程） | 0.6602 | 0.5833 | 16.83 | 5.69 | 23.0% |
| A-0: 仅 Otsu 粗糙轮廓（YOLO 框） | 0.5410 | 0.4617 | 21.27 | 7.16 | 33.8% |
| A-0: 仅 Otsu 粗糙轮廓（GT 框） | 0.6556 | 0.5683 | 20.39 | 6.51 | 21.7% |

**结论**：同条件下 **YOLO26n-seg 更准**（+0.13 Dice）；contour-refiner 自身有效（+0.12 Dice），
方案 A 的瓶颈是**检测框定位精度**（测试集最佳匹配框 IoU 均值 0.759）而非轮廓精细化——
